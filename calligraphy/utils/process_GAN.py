...
# Define DenseBlock and Generator
...
def process_images(input_folder, output_folder, model, transform, device):
    """
    Processes all images in the input folder using the trained GAN model and saves them
...
if __name__ == "__main__":
    ...
    output_folder = "/gpfsnyu/scratch/yl10337/GAN_processed_bdsr"
    process_images(input_folder, output_folder, generator, transform, device)
