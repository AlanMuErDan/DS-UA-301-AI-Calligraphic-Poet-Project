...
gpu = 0
local_rank = gpu
device = torch.device(f'cuda:{local_rank}' if torch.cuda.is_available() else 'cpu')  # Explicitly setting the device
local_rank = 0  # or dynamically set based on your environment
